...
(function(g, n, l) {
    ...
    if (g.trackJs) g.console && g.console.warn && g.console.warn("TrackJS global conflict");
        ...
        p.prototype = {
            watch: function() {
                d.forEach(["EventTarget", "Node", "XMLHttpRequest"], function(a) {
            ...
            wrap: function(a) {
                ...
                var c = this;
                try {
                    if (!d.isFunction(a) || d.hasOwn(a, "__trackjs__")) return a;
                    if (d.hasOwn(a, "__trackjs_state__")) return a.__trackjs_state__
                } catch (m) {
                    return a
                }
                var e, f;
                if (c.config.bindStack) try {
                    ...
                    f = m.stack, e = d.isoNow()
                }
                for (var h in a) d.hasOwn(a, h) && (b[h] = a[h]);
            ...
            wrapEventTarget: function(a) {
                ...
                d.has(a, "addEventListener.call") &&
                    d.has(a, "removeEventListener.call") && (d.patch(a, "addEventListener", function(a) {
            ...
            wrapTimer: function(a) {
                ...
                d.patch(g, a, function(a) {
                    return function(e, f) {
                        ...
                        d.isFunction(m) &&
                            (h[0] = b.wrap(m));
                        return d.has(a, "apply") ? a.apply(this, h) : a(h[0], h[1])
                    }
                })
            }
        };
        ...
        t.prototype = {
            ...
            defaults: {
                ...
                serialize: function(a) {
                    ...
                    if (d.isString(a) || d.isNumber(a) || d.isBoolean(a) || d.isFunction(a)) return "" + a;
                    if (d.isElement(a)) return b(a);
                    var c;
                    try {
                        c = JSON.stringify(a, function(a, c) {
                            return c === l ? "undefined" : d.isNumber(c) && isNaN(c) ? "NaN" : d.isError(c) ? {
                                name: c.name,
                                message: c.message,
                                stack: c.stack
                            } : d.isElement(c) ? b(c) : c
            ...
            initCurrent: function(a) {
                if (this.validate(a, this.defaults, "config", {})) return this.current = d.defaultsDeep({}, a, this.defaults), !0;
                this.current = d.defaultsDeep({}, this.defaults);
                console.log("init current config", this.current);
                return !1
            },
            setCurrent: function(a) {
                return this.validate(a, this.defaults, "config", this.initOnly) ? (this.current = d.defaultsDeep({}, a, this.current), !0) : !1
            },
                ...
                for (var h in a)
                    if (a.hasOwnProperty(h))
                        if (b.hasOwnProperty(h)) {
                            var d =
                                typeof b[h];
                            d !== typeof a[h] ? (console.warn(c + "." + h + ": property must be type " + d + "."), f = !1) : "[object Array]" !== Object.prototype.toString.call(a[h]) || this.validateArray(a[h], b[h], c + "." + h) ? "[object Object]" === Object.prototype.toString.call(a[h]) ? f = this.validate(a[h], b[h], c + "." + h, e[h]) : e.hasOwnProperty(h) && (console.warn(c + "." + h + ": property cannot be set after load."), f = !1) : f = !1
            ...
            validateArray: function(a, b, c) {
                ...
                c = c || "";
                for (var f =
                        0; f < a.length; f++) d.contains(b, a[f]) || (console.warn(c + "[" + f + "]: invalid value: " + a[f] + "."), e = !1);
                return e
            }
        };
                ...
                for (f = 0; f < b.watch.length; f++)(function(f) {
                    ...
                    a[f] = function() {
                        try {
                            ...
                            if (b[f])
                                if (d.isError(a[0]) && 1 === a.length) e.onError("console", a[0]);
                                else try {
                                    throw Error(e.serialize(1 === a.length ? a[0] : a));
                                } catch (c) {
                                    e.onError("console", c)
                                }
                            b.display && (e.util.hasFunction(m, "apply") ? m.apply(this, a) : m(a[0]))
                        } catch (c) {
                            e.onFault(c)
                        }
                    }
        ...
        y.prototype = {
            all: function(a) {
                var b = [],
                    c, e;
                for (e = 0; e < this.appender.length; e++)(c = this.appender[e]) && c.category === a && b.push(c.value);
                return b
            },
            clear: function() {
            ...
            get: function(a, b) {
                ...
                for (e = 0; e < this.appender.length; e++)
                    if (c = this.appender[e], c.category === a && c.key === b) return c.value;
                return !1
            }
        };
        var z = function(a, b) {
        ...
        z.prototype = {
            ...
            watch: function() {
                if (this.isCompatible()) {
                    var a = this,
                        b = d.getLocationURL().relative;
                    g.addEventListener("popstate", function() {
                        var c = d.getLocationURL().relative;
                    ...
                    d.forEach(["pushState",
                        ...
                        d.patch(history, c, function(e) {
                            return function() {
                                b = d.getLocationURL().relative;
                                var f = e.apply(this, arguments),
                                    h = d.getLocationURL().relative;
                                a.record(c, b, h);
                                b = h;
                                return f
                            }
        ...
        A.prototype = {
            ...
            watchFetch: function() {
                ...
                d.patch(g, "fetch", function(e) {
                    return function(f, h) {
                        var m = f instanceof Request ? f : new Request(f, h),
            ...
            watchNetworkObject: function(a) {
                ...
                a.prototype.send = function() {
                    try {
                        if (!this._trackJs) return e.apply(this, arguments);
        ...
        q.prototype = {
            ...
            getCORSRequest: function(a, b) {
                var c;
                this.util.testCrossdomainXhr() ? (c = new g.XMLHttpRequest, c.open(a, b), c.setRequestHeader("Content-Type", "text/plain")) : "undefined" !== typeof g.XDomainRequest ? (c = new g.XDomainRequest, c.open(a, b)) : c = null;
                return c
            },
        ...
        var d = function() {
                function a(c, e, f, h) {
                    ...
                    d.forEach(e, function(e) {
                        d.forEach(d.keys(e), function(d) {
                            null === e[d] || e[d] === l ? c[d] = e[d] : f && 10 > h && "[object Object]" === b(e[d]) ? (c[d] = c[d] || {}, a(c[d], [e[d]], f, h + 1)) : c.hasOwnProperty(d) || (c[d] = e[d])
                        })
                    });
                    return c
                }
                ...
                return {
                    addEventListenerSafe: function(a, b, f, d) {
                        a.addEventListener ? a.addEventListener(b, f, d) : a.attachEvent && a.attachEvent("on" + b, f)
                    },
                    afterDocumentLoad: function(a) {
                        var b = !1;
                        "complete" === n.readyState ? d.defer(a) : (d.addEventListenerSafe(n, "readystatechange", function() {
                    ...
                    forEach: function(a, b, f) {
                        ...
                        for (var d = 0; d < a.length;) b.call(f, a[d], d, a), d++
                    },
                    ...
                    isBrowserIE: function(a) {
                        ...
                        return b &&
                            "7.0" === b[1] ? 11 : (a = a.match(/MSIE ([\d.]+)/)) ? parseInt(a[1], 10) : !1
                    },
                    ...
                    isoNow: function() {
                        var a = new Date;
                        return a.toISOString ? a.toISOString() : a.getUTCFullYear() + "-" + this.pad(a.getUTCMonth() + 1) + "-" + this.pad(a.getUTCDate()) + "T" + this.pad(a.getUTCHours()) + ":" + this.pad(a.getUTCMinutes()) + ":" + this.pad(a.getUTCSeconds()) + "." + String((a.getUTCMilliseconds() /
                    ...
                    wrapError: function(a) {
                        ...
                        var b = Error("TrackJS Caught: " + (a.message ||
                            a));
        ...
        B.prototype = {
            initialize: function(a) {
                ...
                a.addEventListener ? (a.addEventListener("click", b, !0), a.addEventListener("blur",
                    c, !0)) : a.attachEvent && (a.attachEvent("onclick", b), a.attachEvent("onfocusout", c))
            },
            ...
            getElementAttributes: function(a) {
                for (var b = {}, c = 0; c < a.attributes.length; c++) "value" !== a.attributes[c].name.toLowerCase() && (b[a.attributes[c].name] = a.attributes[c].value);
                return b
            },
            ...
            matchInputPattern: function(a) {
                return "" === a ? "empty" : /^[a-z0-9!#$%&'*+=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?$/.test(a) ? "email" : /^(0?[1-9]|[12][0-9]|3[01])[\/\-](0?[1-9]|1[012])[\/\-]\d{4}$/.test(a) || /^(\d{4}[\/\-](0?[1-9]|1[012])[\/\-]0?[1-9]|[12][0-9]|3[01])$/.test(a) ? "date" : /^(?:(?:\+?1\s*(?:[.-]\s*)?)?(?:\(\s*([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9])\s*\)|([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9]))\s*(?:[.-]\s*)?)?([2-9]1[02-9]|[2-9][02-9]1|[2-9][02-9]{2})\s*(?:[.-]\s*)?([0-9]{4})(?:\s*(?:#|x\.?|ext\.?|extension)\s*(\d+))?$/.test(a) ?
                    "usphone" : /^\s*$/.test(a) ? "whitespace" : /^\d*$/.test(a) ? "numeric" : /^[a-zA-Z]*$/.test(a) ? "alpha" : /^[a-zA-Z0-9]*$/.test(a) ? "alphanumeric" : "characters"
            },
            report: function() {
        ...
        C.prototype = {
            watchPromiseErrors: function(a) {
                ...
                a.addEventListener ? a.addEventListener("unhandledrejection", function(a) {
                    a = a || {};
                    a = a.detail ? d.tryGet(a.detail,
                        "reason") : d.tryGet(a, "reason");
                    if (a !== l) {
                        if (!d.isError(a)) try {
            ...
            watchWindowErrors: function(a) {
                ...
                d.patch(a, "onerror", function(a) {
                    return function(e, f, d, g, k) {
                        try {
                            k = k || {}, k.message = k.message || b.serialize(e), k.name = k.name || "Error", k.line = k.line || parseInt(d, 10) || null, k.column = k.column || parseInt(g, 10) || null, "[object Event]" !== Object.prototype.toString.call(e) || f ? k.file = k.file ||
                                b.serialize(f) : k.file = (e.target || {}).src, b.onError("window", k)
                        } catch (x) {
                            b.onFault(x)
                        }
            ...
            try {
                if (this.window = t, this.document = u, this.util = d, this.onError = this.util.bind(this.onError, this), this.onFault = this.util.bind(this.onFault, this), this.serialize = this.util.bind(this.serialize, this), this.config = new e(a), this.transmitter = new n(this.util, this.config), this.log = new k(this.util), this.api = new b(this.config, this.util, this.onError, this.serialize),
                    ...
                    this.callbackWatcher =
                        new c(this.config.current.callback, this.onError, this.onFault);
            ...
            onError: function() {
                ...
                return function(c, e, f) {
                    if (d.isBrowserSupported() &&
                        this.config.current.enabled) try {
                        if (f = f || {
                                bindStack: null,
                                bindTime: null,
                                force: !1
                            ...
                            if (b && -1 !== e.message.indexOf("Script error")) b = !1;
                                ...
                                if (this.config.current.dedupe) {
                                    var k =
                                        (h.message + h.stack).substr(0, 1E4);
                                    if (k === a) return;
                                    a = k
                                }
                                this.log.clear();
            ...
            return {
                ...
                watchAll: function(a) {
                    var e = Array.prototype.slice.call(arguments, 1),
                        d;
                    for (d in a) "function" === typeof a[d] && (b.contains(e, d) || function() {
                        var e = a[d];
                        a[d] = function() {
                            try {
